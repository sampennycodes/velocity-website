...
Choose **Shared → Contact form** to control **How did you hear about us?** The question is optional by default. Use **Show “How did you hear about us?”** to show or hide it, and **Require an answer** to switch between required and optional. These settings apply to every contact form, and the preview updates immediately. The five choices are Word of mouth, Google Search, Search Engine (Other), AI Assistant (ChatGPT, etc.), and Other (Please specify). Other reveals a details field. The answer is included in the enquiry email you receive. Select **Save & update staging** when ready.
