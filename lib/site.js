...
export const PRODUCTION_ORIGIN = 'https://velocitymarketing.com.au';
export const STAGING_ORIGIN = 'https://velocitymarketing-v2.vercel.app';
export const DEFAULT_SOCIAL_IMAGE = '/ogimage-paid-media.png';
export const DEFAULT_SOCIAL_IMAGE_WIDTH = 1731;
export const DEFAULT_SOCIAL_IMAGE_HEIGHT = 909;
...
export function imageSource(source) {
  return ['/ogimage.png', '/ogimage-v2.png'].includes(source) ? DEFAULT_SOCIAL_IMAGE : images[source]?.src || source;
}
