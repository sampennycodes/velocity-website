...
const added = [
  { group: 'home.services', key: 'home.services.3.title', label: 'ChatGPT Ads: title', type: 'text', max: 300, initial: 'ChatGPT Ads', added: true },
  { group: 'home.services', key: 'home.services.3.description', label: 'ChatGPT Ads: description', type: 'textarea', max: 1800, initial: 'Reach people while they\u2019re researching and comparing options in ChatGPT with relevant campaigns designed to turn discovery into measurable growth.', added: true },
  { group: 'home.areas', key: 'home.areas.heading', label: 'Heading', type: 'text', max: 300, initial: 'Areas We Service', added: true },
  { group: 'home.areas', key: 'home.areas.intro', label: 'Introduction', type: 'textarea', max: 1200, initial: 'I work with businesses across Australia and the US. Being based in Traralgon gives me a unique connection to Gippsland and the businesses that call it home.', added: true },
...
const baseGroups = baseline.groups.flatMap(group => [
  ...(group.id === 'home.contact' ? [{ id: 'home.areas', label: 'Areas we service', page: 'home', description: 'Introduce your wider reach and Gippsland connection. Town names link to their pages beneath five region headings.' }] : []),
