...
const schemas = Object.fromEntries(
  fields.map((f) => {
    ...
    if (f.group === "shared.emails") {
      ...
      if (f.key === "shared.emails.senderEmail")
        schema = schema.refine((v) => v.toLowerCase().endsWith("@velocitymarketing.com.au"), "Use the verified velocitymarketing.com.au domain.");
